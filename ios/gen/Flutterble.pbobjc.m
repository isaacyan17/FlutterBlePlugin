...
#pragma mark - ProtosFlutterbleRoot

@implementation ProtosFlutterbleRoot
...
#pragma mark - ProtosFlutterbleRoot_FileDescriptor

static GPBFileDescriptor *ProtosFlutterbleRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosInt32Value class]
                                     rootClass:[ProtosFlutterbleRoot class]
                                          file:ProtosFlutterbleRoot_FileDescriptor()
                                        fields:fields
...
@dynamic reconncectCount;

typedef struct ProtosConnectRequest__storage_ {
  uint32_t _has_storage_[1];
  int32_t reconncectCount;
  NSString *remoteId;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "reconncectCount",
        .dataTypeSpecific.clazz = Nil,
        .number = ProtosConnectRequest_FieldNumber_ReconncectCount,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(ProtosConnectRequest__storage_, reconncectCount),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt32,
      },
    };
...
GPBEnumDescriptor *ProtosDeviceStateResponse_BluetoothDeviceState_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    static const int32_t values[] = {
        ...
        ProtosDeviceStateResponse_BluetoothDeviceState_ConnectFailure,
    };
    GPBEnumDescriptor *worker =
...
BOOL ProtosDeviceStateResponse_BluetoothDeviceState_IsValidValue(int32_t value__) {
  switch (value__) {
    ...
    case ProtosDeviceStateResponse_BluetoothDeviceState_ConnectFailure:
      return YES;
    default:
      return NO;
  }
...
#pragma mark - ProtosDeviceRssi

@implementation ProtosDeviceRssi

@dynamic remoteId;
@dynamic rssi;

typedef struct ProtosDeviceRssi__storage_ {
  uint32_t _has_storage_[1];
  int32_t rssi;
  NSString *remoteId;
} ProtosDeviceRssi__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "remoteId",
        .dataTypeSpecific.clazz = Nil,
        .number = ProtosDeviceRssi_FieldNumber_RemoteId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ProtosDeviceRssi__storage_, remoteId),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "rssi",
        .dataTypeSpecific.clazz = Nil,
        .number = ProtosDeviceRssi_FieldNumber_Rssi,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ProtosDeviceRssi__storage_, rssi),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt32,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosDeviceRssi class]
                                     rootClass:[ProtosFlutterbleRoot class]
                                          file:ProtosFlutterbleRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ProtosDeviceRssi__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
