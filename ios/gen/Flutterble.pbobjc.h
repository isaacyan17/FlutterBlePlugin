...
typedef GPB_ENUM(ProtosDeviceStateResponse_BluetoothDeviceState) {
  ...
  ProtosDeviceStateResponse_BluetoothDeviceState_ConnectFailure = 4,
};
 ...
 **/
GPB_FINAL @interface ProtosFlutterbleRoot : GPBRootObject
@end
...
typedef GPB_ENUM(ProtosConnectRequest_FieldNumber) {
  ...
  ProtosConnectRequest_FieldNumber_ReconncectCount = 3,
};
...
/** 重连次数 */
@property(nonatomic, readwrite) int32_t reconncectCount;
...
typedef GPB_ENUM(ProtosDeviceRssi_FieldNumber) {
  ProtosDeviceRssi_FieldNumber_RemoteId = 1,
  ProtosDeviceRssi_FieldNumber_Rssi = 2,
};

/**
 * 设备rssi信号值
 **/
GPB_FINAL @interface ProtosDeviceRssi : GPBMessage
