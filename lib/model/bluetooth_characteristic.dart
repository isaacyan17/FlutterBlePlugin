...
class BluetoothCharacteristic {
  ...
  Stream<BluetoothCharacteristic> get _onCharacteristicChangedStream =>
      FlutterBlePlatform.instance._methodStream
  ...
  Future<List<int>> read() async {
    ...
    print('remoteId: ${deviceId.toString()} characteristicUuid: ${uuid.toString()} serviceUuid: ${serviceUuid.toString()}');
    // FlutterBlePlatform.instance._log(LogLevel.info,
    //     'remoteId: ${deviceId.toString()} characteristicUuid: ${uuid.toString()} serviceUuid: ${serviceUuid.toString()}');

    await FlutterBlePlatform.instance.invoke('readCharacteristic', request.writeToBuffer());
  ...
  Future<Null> write(List<int> value, {bool withoutResponse = false}) async {
    ...
    var result = await FlutterBlePlatform.instance.invoke('writeCharacteristic', request.writeToBuffer());
  ...
  Future<bool> setNotifyValue(bool notify) async {
    ...
    await FlutterBlePlatform.instance.invoke('setNotification', request.writeToBuffer());
