...
class BluetoothDescriptor {
  ...
  Future<List<int>> read() async {
    ...
    await FlutterBlePlatform.instance.invoke('readDescriptor', request.writeToBuffer());
  ...
  Future<Null> write(List<int> value) async {
    ...
    await FlutterBlePlatform.instance.invoke('writeDescriptor', request.writeToBuffer());
