...
import 'flutterble.pbenum.dart';

export 'flutterble.pbenum.dart';
...
class ConnectRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectRequest', createEmptyInstance: create)
    ...
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reconncectCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  factory ConnectRequest({
    ...
    if (reconncectCount != null) {
      _result.reconncectCount = reconncectCount;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(3)
  $core.int get reconncectCount => $_getIZ(2);
  @$pb.TagNumber(3)
  set reconncectCount($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasReconncectCount() => $_has(2);
  @$pb.TagNumber(3)
  void clearReconncectCount() => clearField(3);
}
...
class DeviceRssi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceRssi', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remoteId')
  ...
  factory DeviceRssi.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeviceRssi.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeviceRssi clone() => DeviceRssi()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceRssi copyWith(void Function(DeviceRssi) updates) => super.copyWith((message) => updates(message as DeviceRssi)) as DeviceRssi; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeviceRssi create() => DeviceRssi._();
  DeviceRssi createEmptyInstance() => create();
  static $pb.PbList<DeviceRssi> createRepeated() => $pb.PbList<DeviceRssi>();
  @$core.pragma('dart2js:noInline')
  static DeviceRssi getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeviceRssi>(create);
  static DeviceRssi? _defaultInstance;
